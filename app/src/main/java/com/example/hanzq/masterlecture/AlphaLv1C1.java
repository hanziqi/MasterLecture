 ...
 */
public class AlphaLv1C1 extends Activity {
    /**
     * 用于展示照片墙的GridView
     */
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        textView.setText("产品型号和特点-ILC_Part");
        ...
        mAdapter = new PhotoWallAdapter(this, 0, AlphaImageL1C1.imageThumbUrls,mPhotoWall);
