 ...
 */
public class WalkmanLv1C4 extends Activity {
    /**
     * 用于展示照片墙的GridView
     */
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        textView.setText("Hi-Res Audio课堂");
        ...
        mAdapter = new PhotoWallAdapter(this, 0, WalkmanImageL1C4.imageThumbUrls,mPhotoWall);
