 ...
 */
public class AlphaLv1C2 extends Activity {
    /**
     * 用于展示照片墙的GridView
     */
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        textView.setText("产品型号和特点-DSC&PV_Part");
        ...
        mAdapter = new PhotoWallAdapter(this, 0, AlphaImageL1C2.imageThumbUrls,mPhotoWall);
