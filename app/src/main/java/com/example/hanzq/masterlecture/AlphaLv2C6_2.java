 ...
 */
public class AlphaLv2C6_2 extends Activity {
    /**
     * 用于展示照片墙的GridView
     */
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        textView.setText("初级摄影技巧2_对焦测光白平衡");
        ...
        mAdapter = new PhotoWallAdapter(this, 0, AlphaImageL2C6_2.imageThumbUrls,mPhotoWall);
