 ...
 */
public class AlphaLv2C6_1 extends Activity {
    /**
     * 用于展示照片墙的GridView
     */
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        textView.setText("初级摄影技巧1_光圈快门ISO");
        ...
        mAdapter = new PhotoWallAdapter(this, 0, AlphaImageL2C6_1.imageThumbUrls,mPhotoWall);
